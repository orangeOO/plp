...
<div class="row">
	...
	<div class="col-xs-10">
		...
		<div class="goods-wrapper white-block">
			<form method="post" action="/goods/{{ $goods->id }}" enctype="multipart/form-data">
				<input type="hidden" name="_method" value="PUT">
				<p class="title"><span class="left">标题：</span><input name="title" type="text" placeholder="请输入物品标题，简明扼要地列出物品属性" value="{{ $goods->title }}"></p>
				<p><span class="left">分类：</span>
					<select name="type">
						@foreach($types as $type)
							@if($type->id == $goods->typeinfo->id)
